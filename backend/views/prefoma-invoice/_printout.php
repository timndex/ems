...
<body>
    <div class="invoice-box">
        ...
        <table  cellspacing="0" style="margin-top: -50px; border-right:1px solid black">
            ...
            foreach ($modelPrefomaSub as  $vals) {
            ...
            ?>
             ...
             <tr class="item" >
                ...
                <td rowspan="1" style="border: 1px solid black; text-align: right;"><?='Ksh'.' '.$cost_qty?></td>
        ...
        <table cellspacing="0">
            ...
            <tr>
                <?php
                            ...
                            foreach ($modelPrefomaInvoiceDetails as  $val) {
                             $item = $val['items'];
