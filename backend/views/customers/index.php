        ...
        'options' => ['class'=>'form-control'],
              ...
              [
                ...
                'update' => function ($url, $model) {
                    ...
                    return Html::a('<i class="glyphicon glyphicon-pencil"></i>', Url::to(['update', 'id' => $model->customer_id]), [
                ...
                'remove' => function ($url, $model) {
                  ...
                  if($model->status==9){
                    ...
                    return Html::a('<i class="glyphicon glyphicon-trash"></i>', Url::to(['disable', 'id' => $model->customer_id]), [
                 ...
                 'restore' => function ($url, $model) {
                  ...
                  if($model->status==0){
                    ...
                    return Html::a('<i class="glyphicon glyphicon-retweet"></i>', Url::to(['restore', 'id' => $model->customer_id]), [
                        'class' => ' btn btn-danger btn-xs',
                        'title'=>'Restore',
                        'data' => [
