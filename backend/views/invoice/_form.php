...
<div class="invoice-form">
    ...
    <?= $form->field($model, 'job_card_number')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'prefoma_number')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'deposit_paid')->textInput(['maxlength' => true]) ?>
