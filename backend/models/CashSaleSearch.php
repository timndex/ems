...
/**
 * CashSaleSearch represents the model behind the search form of `app\models\CashSale`.
 */
class CashSaleSearch extends CashSale
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['id', 'status'], 'integer'],
            [['job_card_number', 'customer_id', 'cost', 'payment', 'tax_amount', 'sales_tax', 'total_amount', 'balance', 'created_at', 'office', 'created_by', 'updated_at', 'updated_by'], 'safe'],
        ];
    }
